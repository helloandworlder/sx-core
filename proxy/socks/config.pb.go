...
const file_proxy_socks_config_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xe1\x03\n" +
	"\fServerConfig\x127\n" +
	"\tauth_type\x18\x01 \x01(\x0e2\x1a.xray.proxy.socks.AuthTypeR\bauthType\x12H\n" +
	"\baccounts\x18\x02 \x03(\v2,.xray.proxy.socks.ServerConfig.AccountsEntryR\baccounts\x12X\n" +
	"\x0eaccount_emails\x18\x05 \x03(\v21.xray.proxy.socks.ServerConfig.AccountEmailsEntryR\raccountEmails\x125\n" +
...
var file_proxy_socks_config_proto_goTypes = []any{
	...
	nil,                             // 5: xray.proxy.socks.ServerConfig.AccountEmailsEntry
...
var file_proxy_socks_config_proto_depIdxs = []int32{
	...
	5, // 2: xray.proxy.socks.ServerConfig.account_emails:type_name -> xray.proxy.socks.ServerConfig.AccountEmailsEntry
	6, // 3: xray.proxy.socks.ServerConfig.address:type_name -> xray.common.net.IPOrDomain
