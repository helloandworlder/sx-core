...
type ServerConfig struct {
	...
	AccountEmails    map[string]string      `protobuf:"bytes,5,rep,name=account_emails,json=accountEmails,proto3" json:"account_emails,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *ServerConfig) GetAccountEmails() map[string]string {
	if x != nil {
		return x.AccountEmails
	}
	return nil
}
...
const file_proxy_http_config_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xfb\x02\n" +
	"\fServerConfig\x12G\n" +
	"\baccounts\x18\x02 \x03(\v2+.xray.proxy.http.ServerConfig.AccountsEntryR\baccounts\x12W\n" +
	"\x0eaccount_emails\x18\x05 \x03(\v20.xray.proxy.http.ServerConfig.AccountEmailsEntryR\raccountEmails\x12+\n" +
...
var file_proxy_http_config_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proxy_http_config_proto_goTypes = []any{
	...
	nil,                             // 5: xray.proxy.http.ServerConfig.AccountEmailsEntry
...
var file_proxy_http_config_proto_depIdxs = []int32{
	...
	5, // 1: xray.proxy.http.ServerConfig.account_emails:type_name -> xray.proxy.http.ServerConfig.AccountEmailsEntry
	6, // 2: xray.proxy.http.ClientConfig.server:type_name -> xray.common.protocol.ServerEndpoint
	2, // 3: xray.proxy.http.ClientConfig.header:type_name -> xray.proxy.http.Header
